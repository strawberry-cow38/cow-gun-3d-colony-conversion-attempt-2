 ...
 * Wall / Door / Torch inside the rect for demolition (posts a 'deconstruct'
 * job and sets the entity's deconstructJobId). Shift+drag cancels existing
 * marks inside the rect.
 *
 * Mirrors ChopDesignator's drag + preview rectangle pattern — the differences
 * are (a) what we query for (Wall/Door/Torch instead of Tree) and (b) the
 * board kind we post ('deconstruct').
 */
